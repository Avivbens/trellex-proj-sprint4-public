...
export default {
	...
	computed: {
		boardMapByLabels() {
			const labelCountMap = this.board.groups.reduce((boardLabelsMap, group) => {
				const labelCountMap = group.tasks.reduce((groupLabelsMap, task) => {
				...
				for (let labelId in labelCountMap) {
